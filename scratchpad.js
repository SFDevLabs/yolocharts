...
var handsOnData = [
  ["day", "type", "number", "", "", ""],
  ["0", "foo", "12", null, null, null],
  ["1", "foo", "23", null, null, null],
  ["2", "foo", "16", null, null, null],
  ["3", "foo", "45", null, null, null],
  ["4", "foo", "23", null, null, null],
  ["5", "foo", "43", null, null, null],
  ["6", "foo", "54", null, null, null],
  ["7", "foo", "23", null, null, null],
  ["8", "foo", "56", null, null, null],
  ["9", "foo", "65", null, null, null],
  ["0", "bar", "13", null, null, null],
  ["1", "bar", "15", null, null, null],
  ["2", "bar", "42", null, null, null],
  ["3", "bar", "54", null, null, null],
  ["4", "bar", "32", null, null, null],
  ["5", "bar", "12", null, null, null],
  ["6", "bar", "23", null, null, null],
  ["7", "bar", "12", null, null, null],
  ["8", "bar", "12", null, null, null],
  ["9", "bar", "22", null, null, null],
  [null, null, null, null, null, null]
];
...
console.log(
  // transform(innerCompact(trimEmptyRows(jeffData)))
  hotToD3(jeffData)
);