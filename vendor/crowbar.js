function crowbar() {
  ...
  function createPopover(sources) {
    console.log('call createPopover');
    cleanup();
  ...
  function getStyles(doc) {
    ...
    function processStyleSheet(ss) {
      console.log('call processStyleSheet');
      if (ss.cssRules) {
